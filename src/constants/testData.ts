...
export const TIER_1_ITEMS: TestItem[] = [
  ...
  { nameEn: 'Crackers', nameDe: 'Cracker', foodType: 'grain', icon: 'bread-slice-outline', category: 'Snacks', tier: 1 },
  ...
  { nameEn: 'Salmon', nameDe: 'Lachs', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 1 },
  { nameEn: 'Tuna', nameDe: 'Thunfisch', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 1 },
  { nameEn: 'Eggs', nameDe: 'Eier', foodType: 'egg', icon: 'egg-outline', category: 'Groceries', tier: 1 },
  { nameEn: 'Shrimp', nameDe: 'Garnelen', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 1 },
  ...
  // ── Sugar / Snacks (8) ──
  { nameEn: 'Chocolate', nameDe: 'Schokolade', foodType: 'sugar', icon: 'candy', category: 'Snacks', tier: 1 },
  { nameEn: 'Cookies', nameDe: 'Kekse', foodType: 'sugar', icon: 'candy', category: 'Snacks', tier: 1 },
  { nameEn: 'Honey', nameDe: 'Honig', foodType: 'sugar', icon: 'candy', category: 'Groceries', tier: 1 },
  { nameEn: 'Jam', nameDe: 'Marmelade', foodType: 'sugar', icon: 'candy', category: 'Groceries', tier: 1 },
  { nameEn: 'Candy', nameDe: 'Bonbons', foodType: 'sugar', icon: 'candy', category: 'Snacks', tier: 1 },
  { nameEn: 'Chips', nameDe: 'Chips', foodType: 'sugar', icon: 'candy', category: 'Snacks', tier: 1 },
  { nameEn: 'Granola Bar', nameDe: 'Müsliriegel', foodType: 'sugar', icon: 'candy', category: 'Snacks', tier: 1 },
  { nameEn: 'Maple Syrup', nameDe: 'Ahornsirup', foodType: 'sugar', icon: 'candy', category: 'Groceries', tier: 1 },
  ...
  { nameEn: 'Dish Soap', nameDe: 'Spülmittel', foodType: 'non_food', icon: 'soap', category: 'Household', tier: 1 },
  { nameEn: 'Garbage Bags', nameDe: 'Müllbeutel', foodType: 'non_food', icon: 'package-variant', category: 'Household', tier: 1 },
  { nameEn: 'Laundry Detergent', nameDe: 'Waschmittel', foodType: 'non_food', icon: 'soap', category: 'Household', tier: 1 },

  // ── Other Groceries / Legumes / Pantry (15) ──
  { nameEn: 'Frozen Pizza', nameDe: 'Tiefkühlpizza', foodType: 'grain', icon: 'bread-slice-outline', category: 'Groceries', tier: 1 },
  { nameEn: 'Canned Tomatoes', nameDe: 'Dosentomaten', foodType: 'vegetable', icon: 'carrot', category: 'Groceries', tier: 1 },
  { nameEn: 'Canned Tuna', nameDe: 'Thunfischdose', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 1 },
  ...
  { nameEn: 'Vanilla Extract', nameDe: 'Vanilleextrakt', foodType: 'sugar', icon: 'candy', category: 'Groceries', tier: 1 },
...
export const TIER_2_ITEMS: TestItem[] = [
  ...
  { nameEn: 'Artichoke', nameDe: 'Artischocke', foodType: 'vegetable', icon: 'artichoke', category: 'Groceries', tier: 2 },
  { nameEn: 'Arugula', nameDe: 'Rucola', foodType: 'vegetable', icon: 'spinach', category: 'Groceries', tier: 2 },
  { nameEn: 'Asparagus', nameDe: 'Spargel', foodType: 'vegetable', icon: 'asparagus', category: 'Groceries', tier: 2 },
  { nameEn: 'Beetroot', nameDe: 'Rote Bete', foodType: 'vegetable', icon: 'carrot', category: 'Groceries', tier: 2 },
  { nameEn: 'Bell Pepper', nameDe: 'Paprika', foodType: 'vegetable', icon: 'bell-pepper', category: 'Groceries', tier: 2 },
  { nameEn: 'Bok Choy', nameDe: 'Pak Choi', foodType: 'vegetable', icon: 'cabbage', category: 'Groceries', tier: 2 },
  { nameEn: 'Broccoli', nameDe: 'Brokkoli', foodType: 'vegetable', icon: 'broccoli', category: 'Groceries', tier: 2 },
  { nameEn: 'Brussels Sprouts', nameDe: 'Rosenkohl', foodType: 'vegetable', icon: 'cabbage', category: 'Groceries', tier: 2 },
  { nameEn: 'Celeriac', nameDe: 'Knollensellerie', foodType: 'vegetable', icon: 'carrot', category: 'Groceries', tier: 2 },
  { nameEn: 'Chard', nameDe: 'Mangold', foodType: 'vegetable', icon: 'spinach', category: 'Groceries', tier: 2 },
  { nameEn: 'Chicory', nameDe: 'Chicorée', foodType: 'vegetable', icon: 'cabbage', category: 'Groceries', tier: 2 },
  { nameEn: 'Collard Greens', nameDe: 'Grünkohl', foodType: 'vegetable', icon: 'spinach', category: 'Groceries', tier: 2 },
  { nameEn: 'Endive', nameDe: 'Endivie', foodType: 'vegetable', icon: 'spinach', category: 'Groceries', tier: 2 },
  ...
  { nameEn: 'Kale', nameDe: 'Grünkohl', foodType: 'vegetable', icon: 'spinach', category: 'Groceries', tier: 2 },
  ...
  { nameEn: 'Radicchio', nameDe: 'Radicchio', foodType: 'vegetable', icon: 'cabbage', category: 'Groceries', tier: 2 },
  { nameEn: 'Rhubarb', nameDe: 'Rhabarber', foodType: 'vegetable', icon: 'carrot', category: 'Groceries', tier: 2 },
  { nameEn: 'Savoy Cabbage', nameDe: 'Wirsing', foodType: 'vegetable', icon: 'cabbage', category: 'Groceries', tier: 2 },
  { nameEn: 'Shallot', nameDe: 'Schalotte', foodType: 'vegetable', icon: 'onion', category: 'Groceries', tier: 2 },
  ...
  { nameEn: 'Greek Yogurt', nameDe: 'Griechischer Joghurt', foodType: 'dairy', icon: 'yogurt', category: 'Groceries', tier: 2 },
  ...
  { nameEn: 'Anchovies', nameDe: 'Sardellen', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  { nameEn: 'Calamari', nameDe: 'Kalmar', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  { nameEn: 'Clams', nameDe: 'Muscheln', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  { nameEn: 'Cod', nameDe: 'Kabeljau', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  { nameEn: 'Crab', nameDe: 'Krabbe', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  { nameEn: 'Eel', nameDe: 'Aal', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  { nameEn: 'Herring', nameDe: 'Hering', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  { nameEn: 'Lobster', nameDe: 'Hummer', foodType: 'fish', icon: 'lobster', category: 'Groceries', tier: 2 },
  { nameEn: 'Mackerel', nameDe: 'Makrele', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  { nameEn: 'Mussels', nameDe: 'Miesmuscheln', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  { nameEn: 'Octopus', nameDe: 'Oktopus', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  { nameEn: 'Oysters', nameDe: 'Austern', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  { nameEn: 'Rainbow Trout', nameDe: 'Regenbogenforelle', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  { nameEn: 'Sardines', nameDe: 'Sardinen', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  { nameEn: 'Shrimp', nameDe: 'Garnelen', foodType: 'fish', icon: 'shrimp', category: 'Groceries', tier: 2 },
  { nameEn: 'Smoked Salmon', nameDe: 'Räucherlachs', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  { nameEn: 'Squid', nameDe: 'Tintenfisch', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  { nameEn: 'Trout', nameDe: 'Forelle', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  { nameEn: 'Tuna Steak', nameDe: 'Thunfischsteak', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  ...
  { nameEn: 'Coconut Milk', nameDe: 'Kokosmilch', foodType: 'legume', icon: 'coconut', category: 'Groceries', tier: 2 },
  ...
  { nameEn: 'Buckwheat', nameDe: 'Buchweizen', foodType: 'grain', icon: 'wheat', category: 'Groceries', tier: 2 },
  { nameEn: 'Bulgur', nameDe: 'Bulgur', foodType: 'grain', icon: 'rice', category: 'Groceries', tier: 2 },
  { nameEn: 'Chickpea Flour', nameDe: 'Kichererbsenmehl', foodType: 'grain', icon: 'flour', category: 'Groceries', tier: 2 },
  ...
  { nameEn: 'Rice Noodles', nameDe: 'Reisnudeln', foodType: 'grain', icon: 'noodle', category: 'Groceries', tier: 2 },
  { nameEn: 'Rye Bread', nameDe: 'Roggenbrot', foodType: 'grain', icon: 'bread-slice-outline', category: 'Groceries', tier: 2 },
  { nameEn: 'Soba Noodles', nameDe: 'Soba-Nudeln', foodType: 'grain', icon: 'noodle', category: 'Groceries', tier: 2 },
  { nameEn: 'Spelt', nameDe: 'Dinkel', foodType: 'grain', icon: 'wheat', category: 'Groceries', tier: 2 },
  ...
  { nameEn: 'Basil (Fresh)', nameDe: 'Basilikum frisch', foodType: 'vegetable', icon: 'spinach', category: 'Groceries', tier: 2 },
  { nameEn: 'Bay Leaves', nameDe: 'Lorbeerblätter', foodType: 'vegetable', icon: 'spinach', category: 'Groceries', tier: 2 },
  ...
  { nameEn: 'Coriander (Fresh)', nameDe: 'Koriander frisch', foodType: 'vegetable', icon: 'spinach', category: 'Groceries', tier: 2 },
  { nameEn: 'Cumin', nameDe: 'Kreuzkümmel', foodType: 'vegetable', icon: 'seed-outline', category: 'Groceries', tier: 2 },
  { nameEn: 'Curry Leaves', nameDe: 'Curryblätter', foodType: 'vegetable', icon: 'spinach', category: 'Groceries', tier: 2 },
  { nameEn: 'Dill', nameDe: 'Dill', foodType: 'vegetable', icon: 'spinach', category: 'Groceries', tier: 2 },
  { nameEn: 'Ginger Root', nameDe: 'Ingwer', foodType: 'vegetable', icon: 'carrot', category: 'Groceries', tier: 2 },
  { nameEn: 'Lemongrass', nameDe: 'Zitronengras', foodType: 'vegetable', icon: 'spinach', category: 'Groceries', tier: 2 },
  { nameEn: 'Nutmeg', nameDe: 'Muskatnuss', foodType: 'vegetable', icon: 'seed-outline', category: 'Groceries', tier: 2 },
  { nameEn: 'Oregano', nameDe: 'Oregano', foodType: 'vegetable', icon: 'spinach', category: 'Groceries', tier: 2 },
  { nameEn: 'Paprika (Smoked)', nameDe: 'Räucherpaprika', foodType: 'vegetable', icon: 'chili-hot', category: 'Groceries', tier: 2 },
  { nameEn: 'Rosemary', nameDe: 'Rosmarin', foodType: 'vegetable', icon: 'spinach', category: 'Groceries', tier: 2 },
  { nameEn: 'Saffron', nameDe: 'Safran', foodType: 'vegetable', icon: 'seed-outline', category: 'Groceries', tier: 2 },
  { nameEn: 'Sage', nameDe: 'Salbei', foodType: 'vegetable', icon: 'spinach', category: 'Groceries', tier: 2 },
  { nameEn: 'Star Anise', nameDe: 'Sternanis', foodType: 'vegetable', icon: 'seed-outline', category: 'Groceries', tier: 2 },
  { nameEn: 'Tarragon', nameDe: 'Estragon', foodType: 'vegetable', icon: 'spinach', category: 'Groceries', tier: 2 },
  { nameEn: 'Thyme', nameDe: 'Thymian', foodType: 'vegetable', icon: 'spinach', category: 'Groceries', tier: 2 },
  ...
  // Sugars & Sweeteners
  { nameEn: 'Agave Syrup', nameDe: 'Agavendicksaft', foodType: 'sugar', icon: 'honey', category: 'Groceries', tier: 2 },
  { nameEn: 'Brown Sugar', nameDe: 'Brauner Zucker', foodType: 'sugar', icon: 'sugar', category: 'Groceries', tier: 2 },
  { nameEn: 'Coconut Sugar', nameDe: 'Kokosblütenzucker', foodType: 'sugar', icon: 'sugar', category: 'Groceries', tier: 2 },
  { nameEn: 'Date Syrup', nameDe: 'Dattelsirup', foodType: 'sugar', icon: 'honey', category: 'Groceries', tier: 2 },
  { nameEn: 'Maple Syrup', nameDe: 'Ahornsirup', foodType: 'sugar', icon: 'honey', category: 'Groceries', tier: 2 },
  { nameEn: 'Molasses', nameDe: 'Melasse', foodType: 'sugar', icon: 'honey', category: 'Groceries', tier: 2 },
  { nameEn: 'Powdered Sugar', nameDe: 'Puderzucker', foodType: 'sugar', icon: 'sugar', category: 'Groceries', tier: 2 },
  { nameEn: 'Stevia', nameDe: 'Stevia', foodType: 'sugar', icon: 'sugar', category: 'Groceries', tier: 2 },
  ...
  { nameEn: 'Coconut Water', nameDe: 'Kokoswasser', foodType: 'beverage', icon: 'coconut', category: 'Beverages', tier: 2 },
  ...
  // Snacks – long-tail
  { nameEn: 'Dark Chocolate (85%)', nameDe: 'Zartbitterschokolade 85%', foodType: 'sugar', icon: 'candy', category: 'Snacks', tier: 2 },
  ...
  { nameEn: 'Olives (Kalamata)', nameDe: 'Kalamata-Oliven', foodType: 'fat', icon: 'olive', category: 'Snacks', tier: 2 },
  { nameEn: 'Olives (Green)', nameDe: 'Grüne Oliven', foodType: 'fat', icon: 'olive', category: 'Snacks', tier: 2 },
  { nameEn: 'Pita Chips', nameDe: 'Pita-Chips', foodType: 'grain', icon: 'pizza', category: 'Snacks', tier: 2 },
  { nameEn: 'Popcorn (Kernels)', nameDe: 'Popcornmais', foodType: 'grain', icon: 'popcorn', category: 'Snacks', tier: 2 },
  { nameEn: 'Pretzel Sticks', nameDe: 'Laugenstangen', foodType: 'grain', icon: 'pretzel', category: 'Snacks', tier: 2 },
  { nameEn: 'Protein Bar', nameDe: 'Proteinriegel', foodType: 'sugar', icon: 'candy', category: 'Snacks', tier: 2 },
  { nameEn: 'Rice Cakes', nameDe: 'Reiswaffeln', foodType: 'grain', icon: 'rice', category: 'Snacks', tier: 2 },
  { nameEn: 'Seaweed Snacks', nameDe: 'Algensnacks', foodType: 'vegetable', icon: 'spinach', category: 'Snacks', tier: 2 },
  { nameEn: 'Tortilla Chips', nameDe: 'Tortilla-Chips', foodType: 'grain', icon: 'pizza', category: 'Snacks', tier: 2 },
  ...
  { nameEn: 'Dish Soap', nameDe: 'Spülmittel', foodType: 'non_food', icon: 'soap', category: 'Household', tier: 2 },
  ...
  { nameEn: 'Kitchen Roll', nameDe: 'Küchenrolle', foodType: 'non_food', icon: 'toilet-paper', category: 'Household', tier: 2 },
  { nameEn: 'Laundry Detergent', nameDe: 'Waschmittel', foodType: 'non_food', icon: 'soap', category: 'Household', tier: 2 },
  ...
  { nameEn: 'Hand Cream', nameDe: 'Handcreme', foodType: 'non_food', icon: 'soap', category: 'Personal', tier: 2 },
  ...
  { nameEn: 'Shampoo', nameDe: 'Shampoo', foodType: 'non_food', icon: 'soap', category: 'Personal', tier: 2 },
  { nameEn: 'Shaving Cream', nameDe: 'Rasierschaum', foodType: 'non_food', icon: 'spray-bottle', category: 'Personal', tier: 2 },
  { nameEn: 'Sunscreen', nameDe: 'Sonnencreme', foodType: 'non_food', icon: 'soap', category: 'Personal', tier: 2 },
  ...
  { nameEn: 'Pet Shampoo', nameDe: 'Tiershampoo', foodType: 'non_food', icon: 'soap', category: 'Pet', tier: 2 },
