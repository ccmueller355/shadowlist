...
export const TIER_2_ITEMS: TestItem[] = [
  ...
  { nameEn: 'Lobster', nameDe: 'Hummer', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
  ...
  { nameEn: 'Shrimp', nameDe: 'Garnelen', foodType: 'fish', icon: 'fish', category: 'Groceries', tier: 2 },
