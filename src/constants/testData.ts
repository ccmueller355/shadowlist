...
export const TIER_1_ITEMS: TestItem[] = [
  ...
  // ── Grain (10) ──
  { nameEn: 'Bread', nameDe: 'Brot', foodType: 'bakery', icon: 'bread-slice-outline', category: 'Groceries', tier: 1 },
  { nameEn: 'Rice', nameDe: 'Reis', foodType: 'bakery', icon: 'rice', category: 'Groceries', tier: 1 },
  { nameEn: 'Pasta', nameDe: 'Nudeln', foodType: 'bakery', icon: 'rice', category: 'Groceries', tier: 1 },
  { nameEn: 'Flour', nameDe: 'Mehl', foodType: 'bakery', icon: 'bread-slice-outline', category: 'Groceries', tier: 1 },
  { nameEn: 'Oats', nameDe: 'Haferflocken', foodType: 'bakery', icon: 'seed', category: 'Groceries', tier: 1 },
  { nameEn: 'Cereal', nameDe: 'Müsli', foodType: 'bakery', icon: 'seed', category: 'Groceries', tier: 1 },
  { nameEn: 'Tortilla', nameDe: 'Tortilla', foodType: 'bakery', icon: 'bread-slice-outline', category: 'Groceries', tier: 1 },
  { nameEn: 'Couscous', nameDe: 'Couscous', foodType: 'bakery', icon: 'seed', category: 'Groceries', tier: 1 },
  { nameEn: 'Quinoa', nameDe: 'Quinoa', foodType: 'bakery', icon: 'seed', category: 'Groceries', tier: 1 },
  { nameEn: 'Crackers', nameDe: 'Cracker', foodType: 'bakery', icon: 'bread-slice-outline', category: 'Snacks', tier: 1 },
  ...
  { nameEn: 'Frozen Pizza', nameDe: 'Tiefkühlpizza', foodType: 'bakery', icon: 'bread-slice-outline', category: 'Groceries', tier: 1 },
...
export const TIER_2_ITEMS: TestItem[] = [
  ...
  { nameEn: 'Buckwheat', nameDe: 'Buchweizen', foodType: 'bakery', icon: 'rice', category: 'Groceries', tier: 2 },
  { nameEn: 'Bulgur', nameDe: 'Bulgur', foodType: 'bakery', icon: 'rice', category: 'Groceries', tier: 2 },
  { nameEn: 'Chickpea Flour', nameDe: 'Kichererbsenmehl', foodType: 'bakery', icon: 'rice', category: 'Groceries', tier: 2 },
  { nameEn: 'Couscous', nameDe: 'Couscous', foodType: 'bakery', icon: 'rice', category: 'Groceries', tier: 2 },
  { nameEn: 'Crispbread', nameDe: 'Knäckebrot', foodType: 'bakery', icon: 'bread-slice-outline', category: 'Groceries', tier: 2 },
  { nameEn: 'Farro', nameDe: 'Emmer', foodType: 'bakery', icon: 'rice', category: 'Groceries', tier: 2 },
  { nameEn: 'Gnocchi', nameDe: 'Gnocchi', foodType: 'bakery', icon: 'pasta', category: 'Groceries', tier: 2 },
  { nameEn: 'Millet', nameDe: 'Hirse', foodType: 'bakery', icon: 'seed-outline', category: 'Groceries', tier: 2 },
  { nameEn: 'Oatmeal', nameDe: 'Haferflocken', foodType: 'bakery', icon: 'seed-outline', category: 'Groceries', tier: 2 },
  { nameEn: 'Panko Breadcrumbs', nameDe: 'Panko', foodType: 'bakery', icon: 'bread-slice-outline', category: 'Groceries', tier: 2 },
  { nameEn: 'Polenta', nameDe: 'Polenta', foodType: 'bakery', icon: 'corn', category: 'Groceries', tier: 2 },
  { nameEn: 'Pumpkin Seeds', nameDe: 'Kürbiskerne', foodType: 'bakery', icon: 'seed-outline', category: 'Groceries', tier: 2 },
  { nameEn: 'Quinoa', nameDe: 'Quinoa', foodType: 'bakery', icon: 'seed-outline', category: 'Groceries', tier: 2 },
  { nameEn: 'Rice Noodles', nameDe: 'Reisnudeln', foodType: 'bakery', icon: 'pasta', category: 'Groceries', tier: 2 },
  { nameEn: 'Rye Bread', nameDe: 'Roggenbrot', foodType: 'bakery', icon: 'bread-slice-outline', category: 'Groceries', tier: 2 },
  { nameEn: 'Soba Noodles', nameDe: 'Soba-Nudeln', foodType: 'bakery', icon: 'pasta', category: 'Groceries', tier: 2 },
  { nameEn: 'Spelt', nameDe: 'Dinkel', foodType: 'bakery', icon: 'rice', category: 'Groceries', tier: 2 },
  { nameEn: 'Sushi Rice', nameDe: 'Sushireis', foodType: 'bakery', icon: 'rice', category: 'Groceries', tier: 2 },
  { nameEn: 'Tortilla Wrap', nameDe: 'Tortilla-Wrap', foodType: 'bakery', icon: 'bread-slice-outline', category: 'Groceries', tier: 2 },
  { nameEn: 'Whole Wheat Pasta', nameDe: 'Vollkornnudeln', foodType: 'bakery', icon: 'pasta', category: 'Groceries', tier: 2 },
  ...
  // Sugars & Sweeteners
  { nameEn: 'Agave Syrup', nameDe: 'Agavendicksaft', foodType: 'sugar', icon: 'bee', category: 'Groceries', tier: 2 },
  { nameEn: 'Brown Sugar', nameDe: 'Brauner Zucker', foodType: 'sugar', icon: 'candy', category: 'Groceries', tier: 2 },
  { nameEn: 'Coconut Sugar', nameDe: 'Kokosblütenzucker', foodType: 'sugar', icon: 'candy', category: 'Groceries', tier: 2 },
  { nameEn: 'Date Syrup', nameDe: 'Dattelsirup', foodType: 'sugar', icon: 'bee', category: 'Groceries', tier: 2 },
  { nameEn: 'Maple Syrup', nameDe: 'Ahornsirup', foodType: 'sugar', icon: 'bee', category: 'Groceries', tier: 2 },
  { nameEn: 'Molasses', nameDe: 'Melasse', foodType: 'sugar', icon: 'bee', category: 'Groceries', tier: 2 },
  { nameEn: 'Powdered Sugar', nameDe: 'Puderzucker', foodType: 'sugar', icon: 'candy', category: 'Groceries', tier: 2 },
  { nameEn: 'Stevia', nameDe: 'Stevia', foodType: 'sugar', icon: 'candy', category: 'Groceries', tier: 2 },
  ...
  { nameEn: 'Granola', nameDe: 'Granola', foodType: 'bakery', icon: 'seed-outline', category: 'Snacks', tier: 2 },
  ...
  { nameEn: 'Pita Chips', nameDe: 'Pita-Chips', foodType: 'bakery', icon: 'pizza', category: 'Snacks', tier: 2 },
  { nameEn: 'Popcorn (Kernels)', nameDe: 'Popcornmais', foodType: 'bakery', icon: 'popcorn', category: 'Snacks', tier: 2 },
  { nameEn: 'Pretzel Sticks', nameDe: 'Laugenstangen', foodType: 'bakery', icon: 'pretzel', category: 'Snacks', tier: 2 },
  { nameEn: 'Protein Bar', nameDe: 'Proteinriegel', foodType: 'sugar', icon: 'candy', category: 'Snacks', tier: 2 },
  { nameEn: 'Rice Cakes', nameDe: 'Reiswaffeln', foodType: 'bakery', icon: 'rice', category: 'Snacks', tier: 2 },
  { nameEn: 'Seaweed Snacks', nameDe: 'Algensnacks', foodType: 'vegetable', icon: 'fish', category: 'Snacks', tier: 2 },
  { nameEn: 'Tortilla Chips', nameDe: 'Tortilla-Chips', foodType: 'bakery', icon: 'pizza', category: 'Snacks', tier: 2 },
