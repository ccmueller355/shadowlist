...
export const DEMO_ITEMS_EN: ShoppingItem[] = [
  ...
  { id: 'item_demo_6', listId: 'list_demo_1', description: 'Bread',         qualifier: '1x',    icon: 'bread-slice-outline',   foodType: 'bakery',      purchased: false, order: 5, category: 'Groceries',  createdAt: now, updatedAt: now },
  ...
  { id: 'item_demo_12', listId: 'list_demo_1', description: 'Rice',         qualifier: '1kg',   icon: 'rice',                  foodType: 'bakery',      purchased: false, order: 7, category: 'Groceries',  createdAt: now, updatedAt: now },
  ...
  { id: 'item_demo_13', listId: 'list_demo_2', description: 'Croissant',    qualifier: '2x',    icon: 'bread-slice-outline',   foodType: 'bakery',      purchased: false, order: 0, category: 'Groceries',  createdAt: now, updatedAt: now },
  { id: 'item_demo_14', listId: 'list_demo_2', description: 'Bagels',       qualifier: '4x',    icon: 'baguette',                 foodType: 'bakery',      purchased: false, order: 1, category: 'Groceries',  createdAt: now, updatedAt: now },
  ...
  { id: 'item_demo_18', listId: 'list_demo_2', description: 'Cheddar Crackers', qualifier: '1 box', icon: 'pizza',             foodType: 'bakery',      purchased: true,  order: 5, category: 'Snacks',     createdAt: now - 86400000, updatedAt: now },
...
export const DEMO_ITEMS_DE: ShoppingItem[] = [
  ...
  { id: 'item_demo_6', listId: 'list_demo_1', description: 'Brot',          qualifier: '1x',    icon: 'bread-slice-outline',   foodType: 'bakery',      purchased: false, order: 5, category: 'Groceries',  createdAt: now, updatedAt: now },
  ...
  { id: 'item_demo_12', listId: 'list_demo_1', description: 'Reis',         qualifier: '1kg',   icon: 'rice',                  foodType: 'bakery',      purchased: false, order: 7, category: 'Groceries',  createdAt: now, updatedAt: now },
  ...
  { id: 'item_demo_18', listId: 'list_demo_2', description: 'Cheddar Cracker', qualifier: '1 Pack', icon: 'pizza',           foodType: 'bakery',      purchased: true,  order: 5, category: 'Snacks',     createdAt: now - 86400000, updatedAt: now },
